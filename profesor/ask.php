...
<body>
    ...
    <header class="d-flex flex-wrap justify-content-between align-items-center py-3 px-4" id="prin">
        ...
        <ul class="nav align-items-center gap-1 mb-0">
            ...
            <li><a href="foro.php?uid=<?= $uid ?>" class="nav-link active">Foro</a></li>
            <li>
                    ...
                    <div class="ask-card">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="lang-dropdown-wrap" id="lang-dropdown-wrap">
                                ...
                                <div id="lang-panel" class="lang-panel">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <label class="lang-option"><input type="checkbox" value="c++"
                                                onchange="toggleLanguage(this.value)"> C++</label>

                                        <label class="lang-option">
                                            <input type="checkbox" id="cb-otro" value="otro" onchange="checkOtro(this)">
                                            Otro
                                        </label>
                                    </div>
                            ...
                            <div id="nuevo-lenguaje-group" class="mt-2">
                                <input type="text" class="form-control" id="ask-custom-lang"
                                    placeholder="Ej: Haskell, Elixir, Dart..." maxlength="50">
