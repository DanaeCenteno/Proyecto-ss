                ...
                <div class="ask-card">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="ask-title"
                            placeholder="Ej: ¿Cómo manejar excepciones en Python con try/except?"
                            maxlength="150" autocomplete="off">
                        <div class="invalid-feedback">El título es obligatorio y debe contener al menos 10 caracteres.</div>
                    </div>
                        ...
                        <div class="lang-dropdown-wrap" id="lang-dropdown-wrap">
                            ...
                            <div id="lang-panel" class="lang-panel">
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <label class="lang-opt"><input type="checkbox" value="csharp"     onchange="toggleLanguage(this.value)"> C#</label>
                                    <label class="lang-opt"><input type="checkbox" value="cpp"        onchange="toggleLanguage(this.value)"> C++</label>
                                    <label class="lang-opt"><input type="checkbox" value="typescript" onchange="toggleLanguage(this.value)"> TypeScript</label>
                                    <label class="lang-opt"><input type="checkbox" value="go"         onchange="toggleLanguage(this.value)"> Go</label>
                                    <label class="lang-opt"><input type="checkbox" value="rust"       onchange="toggleLanguage(this.value)"> Rust</label>
                                    <label class="lang-opt"><input type="checkbox" value="kotlin"     onchange="toggleLanguage(this.value)"> Kotlin</label>
                                    <label class="lang-opt"><input type="checkbox" value="swift"      onchange="toggleLanguage(this.value)"> Swift</label>
                    
                                    <label class="lang-opt"><input type="checkbox" value="otro" id="cb-otro" onchange="checkOtro(this)"> Otro</label>
                                </div>
...
<footer>
    <div id="div-footer">
        ...
        <div style="display:flex;gap:24px;">
            <a href="index.php?uid=<?= $uid ?>" style="font-size:13px;color:rgba(255,255,255,.4);text-decoration:none;">Inicio</a>
            <a href="index.php?uid=<?= $uid ?>#cursos" style="font-size:13px;color:rgba(255,255,255,.4);text-decoration:none;">Cursos</a>
            <a href="foroEs.php?uid=<?= $uid ?>" style="font-size:13px;color:rgba(255,255,255,.4);text-decoration:none;">Foro</a>
        </div>
    </div>
</footer>
...
function resetForm() {
    ...
    if (tituloInput) { tituloInput.value = ''; tituloInput.classList.remove('is-invalid','is-valid'); }
